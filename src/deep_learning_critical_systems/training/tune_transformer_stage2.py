"""Second-stage validation tuning for the Transformer model.

Stage 1 tested individual hyperparameter changes against the untuned
Transformer baseline.

Stage 2 now investigates the strongest result from Stage 1 in more
detail:

- nearby learning rates around the Stage-1 winner
- combinations with lower dropout
- combinations with a smaller encoder architecture
...
STAGE_2_CONFIGURATIONS = [
    {
        "run_id": "T7",
        "description": "Lower learning rate around T1",
        **BASE_MODEL_CONFIGURATION,
        "learning_rate": 0.00025,
    },
    {
        "run_id": "T8",
        "description": "Intermediate learning rate around T1",
        **BASE_MODEL_CONFIGURATION,
        "learning_rate": 0.00075,
    },
    {
        "run_id": "T9",
        "description": "T1 learning rate with lower dropout",
        **BASE_MODEL_CONFIGURATION,
        "dropout": 0.10,
    },
    {
        "run_id": "T10",
        "description": "T1 learning rate with one encoder layer",
        **BASE_MODEL_CONFIGURATION,
        "num_layers": 1,
    },
    {
...
def save_selected_model(
    ...
    """Save the final Transformer selected using validation results."""
...
def main() -> None:
    ...
    #
    # If a Stage-2 configuration wins, its model state is available
    # directly from this run.
    #
    # If T1 remains the winner, the already saved Stage-1 tuned
    # checkpoint remains the correct final checkpoint and is reloaded
    # below.
    #
